    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-green-500 selection:text-black font-sans overflow-x-hidden relative">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-6 py-6 md:px-12 mix-blend-difference">
                ...
                <div className="hidden sm:block px-6 py-2 bg-white/20 text-white font-medium rounded-full border border-white/30 cursor-not-allowed">
            ...
            <section className="relative min-h-screen flex flex-col justify-center items-center px-4 overflow-hidden">
                ...
                <div className="z-10 text-center max-w-5xl mx-auto space-y-8">
                    ...
                    >
                        ...
                        <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl gap-2 font-black tracking-tighter leading-[0.9] bg-clip-text text-transparent bg-gradient-to-b from-white to-white/50">
                            SUSTAINABLE
                            <br />
                            HACKATHON
                        </h1>
                    ...
                    <motion.p
                        ...
                        className="px-4 sm:px-6 text-lg md:text-2xl text-zinc-400 max-w-2xl mx-auto leading-relaxed"
                    >
                    ...
                    >
                        ...
                        <div className="rounded-full bg-white/10 px-6 py-2 flex items-center gap-2">
                            <Siren className="text-green-500" />
                            <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r to-background from-green-400">Stay Tuned</h2>
                        </div>
                    </motion.div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="text-left">
                        ...
                        <p className="text-zinc-500 text-sm">
                            © {new Date().getFullYear()} Rotaract Hackathon. All rights reserved.
                        </p>
                    </div>
                    <div className="flex gap-6">
                        ...
                        >
                            <div className="flex items-center gap-2"><Instagram /> Instagram</div>
                        </a>
                    </div>
                </div>
            </footer>
