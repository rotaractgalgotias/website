...
function Hero() {
    return (
        <div>
            <div className='className="flex min-h-screen flex-col items-center bg-[#09090B] text-white"'>
                <section className="w-full relative overflow-hidden h-screen flex items-center justify-center">
                    <motion.div
                    ...
                    <div className="relative z-20 text-center max-w-4xl px-4">
                        ...
                        >
                            Join our community of sponsors and help shape the future of our project. Every contribution makes a difference.                        </motion.p>
                        <motion.div
