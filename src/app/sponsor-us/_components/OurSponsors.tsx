              ...
              {[
                {
                  ...
                  title: "Global Reach",
                  description:
                    "Connect with a diverse audience of innovators and thought leaders worldwide.",
                },
                {
                  icon: BarChart,
                  title: "Measurable Impact",
                  description:
                    "See tangible results and drive meaningful change through your sponsorship.",
                },
                {
                  icon: Network,
                  title: "Exclusive Network",
                  description:
                    "Join a community of industry pioneers and key decision-makers.",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
